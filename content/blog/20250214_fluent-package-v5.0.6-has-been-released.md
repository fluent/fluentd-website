...
As bundled Fluentd was updated to 1.16.7.
...
could not keep some registry values when upgrading installer.

Thus, if you modify Fluentd service (`fluentdwinsvc`) related registry,
you need restore your configuration after upgrading.
