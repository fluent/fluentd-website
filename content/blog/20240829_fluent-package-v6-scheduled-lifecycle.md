...
* Normal release (6.x series)
  ...
  * Fluentd will be upgraded occasionally
      * Minor upgrade will be applied. e.g. 1.17 => 1.18 and so on.
      * e.g. v6.0.1 (Fluentd v1.17.1), v6.0.2 (Fluentd v1.17.2), ... v6.1.0 (Fluentd v1.18.0)
...
* LTS (Long Term Support, 6.0.x series)
  ...
  * Fluentd will be upgraded only in the teeny version and will stick to 1.17.x series. (T.B.D.)
      * Thus, the version number will be 6.0.x. (6.1 series will not be shipped)
      * e.g. v6.0.1 (Fluentd v1.17.1), v6.0.2 (Fluentd v1.17.2), v6.0.3 (Fluentd v1.17.3) ... v6.0.x (Fluentd v1.17.x) and so on.
